  ...
  <div class="container">
      ...
      <div class="d-flex pt-3 pb-1 justify-content-between top-bar overlay">
        <router-link class="navbar-brand d-flex" :to="{ name: 'Account' }">
          <div class="profile">
            ...
            <img
              class="user-icon"
              src="../assets/img/user-icon_1.png"
        ...
        <div>
          ...
          <div
            @click="goToTripRoutes"
            class="d-flex justify-content-end"
            id="slide"
          >
            <h4 class="bg-body p-1 px-2 text-primary rounded">Route Details</h4>
          </div>
    ...
    <div class="row">
      <div class="bottom travelers p-0">
        <img
          class="selectable t-height"
          src="../assets/img/traveler-bg(updated).png"
          alt=""
        />
      </div>
      <div class="bottom supplies p-0">
        <img
          class="s-height"
          src="../assets/img/supplies-bg(updated).png"
          style="width: 100vw"
          alt=""
        />
        ...
        <div @click="goToTravelersPage" class="selectable ms-3">
          <img
            class="travelers-bg"
            src="../assets/img/travelers-bg.png"
            alt=""
          />
          <i class="mdi mdi-account-multiple travelers-logo"></i>
        </div>
        <div class="join-code">
          <h6 class="mb-0">Join Code:</h6>
